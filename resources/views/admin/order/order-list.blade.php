          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table id="productsTable" class="mdl-data-table product-table m-t-30" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th data-orderable="false" class="col-xs-2">User</th>
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                         @if($hire->process=='pending')
                          <li role="presentation">
                            <form action="{{route('admin.manage-order.edit',$hire->id)}}" method="get" onsubmit="return confirm('Are you sure?');" title="Click to approve">
                             @csrf
                             <button  style="border: none; background-color: transparent;outline: none;cursor: pointer;"><i class="zmdi zmdi-block zmdi-hc-2x"></i></button>
                         </form>
                          </li>
                         @else
                          <li role="presentation">
                             <a style="padding-left: 2px !important" href="#"><i class="zmdi zmdi-badge-check zmdi-hc-2x"></i></a>
