        ...
        <div class="col-xs-12">
          <header id="header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="{{route('admin.manage-photos.index')}}">Photograph</a></li>
      ...
      <div class="col-xs-12">
        <div class="card card-data-tables product-table-wrapper">
          <header class="card-heading">
            <h2 class="card-title">Manage Photo</h2>
              @if(session()->has('msg'))
              ...
              <table id="productsTable" class="mdl-data-table product-table m-t-30" cellspacing="0" width="100%">
                ...
                <tbody id="rowadd">
                  ...
                  <tr>
                    ...
                    <td><img src="{{asset($product->photo)}}" alt="" class="img-thumbnail" /></td>
                    <td>{{$product->title}}</td>
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                          <li role="presentation">
                            <a style="padding-left: 2px !important" href="{{route('admin.manage-photos.edit',$product->id)}}"><i class="zmdi zmdi-edit"></i></a>
                          </li>
                          <li role="presentation">
                           <form action="{{route('admin.manage-photos.destroy',$product->id)}}" method="post" onsubmit="return confirm('Are you sure?');">
                             @csrf
                             @method('DELETE')
              ...
              <div class="tab-content">
                <div class="tab-pane fadeIn active" id="product_add_general">
                  <div class="card card p-20 p-t-10 m-b-0">
                    <div class="card-body">
                      <form class="form-horizontal" action="{{route('admin.manage-photos.store')}}" method="post" enctype="multipart/form-data" id="createFormSubmit">
                        @csrf
                        ...
                        <div class="form-group label-floating is-empty">
                            <select class="form-control" id="sel1" name="categorid" value="{{old('category_id')}}">
                        ...
                        <div class="form-group ">
                           ...
                           <input type="file" id="avatar" name="photo" class="custom-file-input">
