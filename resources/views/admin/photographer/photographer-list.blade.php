        ...
        <div class="col-xs-12">
          <header id="header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="{{route('admin.manage-users.create')}}">Photographer</a></li>
      ...
      <div class="col-xs-12">
        <div class="card card-data-tables product-table-wrapper">
          <header class="card-heading">
            <h2 class="card-title">Manage Photographer</h2>
              @if(session()->has('msg'))
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                         @if($user->status==1)
                          <li role="presentation">
                            <form action="{{route('admin.manage-users.show',$user->id)}}" method="get" onsubmit="return confirm('Are you sure?');" title="Block User">
                         ...
                         @else
                          <li role="presentation">
                           <form action="{{route('admin.manage-users.update',$user->id)}}" method="post" onsubmit="return confirm('Are you sure?');" title="Unblock User">
                             @csrf
                             @method('PATCH')
