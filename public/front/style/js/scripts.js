$(document).ready(function() {
    ...
    if ($("#instafeed").length > 0) {
		$("#instafeed").instastory({
			...
			imageSize: 240,
			limit: 10,
			template: '<div class="item"><figure class="overlay"><a href="{{link}}" target="_blank"><span class="over"></span><img src="{{image}}" /></a></figure></div>',
			after: function()
			{
    ...
    if ($("#instafeed-widget").length > 0) {
		$("#instafeed-widget").instastory({
			...
			imageSize: 240,
			limit: 6,
			template: '<div class="item col-xs-4 col-sm-6 col-md-4"><figure class="overlay"><a href="{{link}}" target="_blank"><span class="over"></span><img src="{{image}}" /></a></figure></div>',
		});
	}
    /*-----------------------------------------------------------------------------------*/
    /*	DATA REL
